...
(function(){
    ...
    angular.module('SmartAdmin.Modal', []);
})();
(function(){
    "use strict";
...
angular.module("app").run(["$templateCache", function($templateCache) {$templateCache.put("app/dashboard/live-feeds.tpl.html","<div jarvis-widget id=\"live-feeds-widget\" data-widget-togglebutton=\"false\" data-widget-editbutton=\"false\"\r\n     data-widget-fullscreenbutton=\"false\" data-widget-colorbutton=\"false\" data-widget-deletebutton=\"false\">\r\n    <!-- widget options:\r\n    usage: <div class=\"jarviswidget\" id=\"wid-id-0\" data-widget-editbutton=\"false\">\r\n\r\n    data-widget-colorbutton=\"false\"\r\n    data-widget-editbutton=\"false\"\r\n    data-widget-togglebutton=\"false\"\r\n    data-widget-deletebutton=\"false\"\r\n    data-widget-fullscreenbutton=\"false\"\r\n    data-widget-custombutton=\"false\"\r\n    data-widget-collapsed=\"true\"\r\n    data-widget-sortable=\"false\"\r\n\r\n    -->\r\n    <header>\r\n        <span class=\"widget-icon\"> <i class=\"glyphicon glyphicon-stats txt-color-darken\"></i> </span>\r\n\r\n        <h2>{{getWord(\'Statistics\')}} </h2>\r\n\r\n        <ul class=\"nav nav-tabs pull-right in\" id=\"myTab\">\r\n            <li class=\"active\">\r\n                <a data-toggle=\"tab\" href=\"#s1\"><i class=\"fa fa-clock-o\"></i> {{getWord(\'Work time/Designated time\')}}</a>\r\n            </li>\r\n\r\n            <li>\r\n                <a data-toggle=\"tab\" href=\"#s2\"><i class=\"fa fa-bolt\"></i> <span class=\"hidden-mobile hidden-tablet\">{{getWord(\'Electricity & Water/Time\')}}</span></a>\r\n            </li>\r\n        </ul>\r\n\r\n    </header>\r\n\r\n    <!-- widget div-->\r\n    <div class=\"no-padding\">\r\n\r\n        <div class=\"widget-body\">\r\n            <!-- content -->\r\n            <div id=\"myTabContent\" class=\"tab-content\">\r\n                <div class=\"tab-pane fade active in padding-10 no-padding-bottom\" id=\"s1\">\r\n                    <div class=\"widget-body-toolbar bg-color-white\">\r\n\r\n                        <div class=\"col-sm-12 col-md-12 col-lg-8\">\r\n                            <form class=\"form-inline\" role=\"form\">\r\n\r\n                                <div class=\"form-group\">\r\n                                    <label>{{getWord(\'From/To\')}}</label>\r\n                                    <div class=\"input-group\">\r\n                                        <input type=\"text\" class=\"form-control\" style=\"direction: ltr;\"\r\n                                               data-smart-masked-input=\"1399/99/99\" data-mask-placeholder=\"-\">\r\n                                        <span class=\"input-group-addon\"><i class=\"fa fa-calendar\"></i></span>\r\n                                    </div>\r\n                                    <div class=\"input-group\">\r\n                                        <input type=\"text\" class=\"form-control\" style=\"direction: ltr;\"\r\n                                               data-smart-masked-input=\"1399/99/99\" data-mask-placeholder=\"-\">\r\n                                        <span class=\"input-group-addon\"><i class=\"fa fa-calendar\"></i></span>\r\n                                    </div>\r\n                                </div>\r\n                            </form>\r\n                        </div>\r\n                        <div class=\"col-sm-12 col-md-12 col-lg-4\">\r\n                            <div class=\"smart-form\" id=\"work-toggles\">\r\n\r\n                                <div class=\"inline-group pull-right\">\r\n\r\n                                    <label for=\"gra-0\" class=\"checkbox\">\r\n                                        <input type=\"checkbox\" id=\"gra-0\" ng-model=\"workOrderShow\">\r\n                                        <i></i> {{getWord(\'Work orders time\')}}</label>\r\n                                    <label for=\"gra-1\" class=\"checkbox\">\r\n                                        <input type=\"checkbox\" id=\"gra-1\" ng-model=\"designatedTimeShow\">\r\n                                        <i></i> {{getWord(\'Designated time\')}}</label>\r\n                                </div>\r\n                            </div>\r\n                        </div>\r\n                    </div>\r\n                    <div class=\"padding-10\">\r\n\r\n                        <div id=\"statsChart\" class=\"chart-large has-legend-unique\" flot-basic flot-data=\"statsData\"\r\n                             flot-options=\"statsDisplayOptions\"></div>\r\n                    </div>\r\n\r\n                </div>\r\n                <!-- end s2 tab pane -->\r\n\r\n                <div class=\"tab-pane fade in padding-10 no-padding-bottom\" id=\"s2\">\r\n\r\n                    <div class=\"widget-body-toolbar bg-color-white smart-form\" id=\"rev-toggles\">\r\n\r\n                        <div class=\"inline-group\">\r\n\r\n                            <label for=\"gra-3\" class=\"checkbox\">\r\n                                <input type=\"checkbox\" id=\"gra-3\" ng-model=\"electricityShow\">\r\n                                <i></i> {{getWord(\'Electricity\')}}</label>\r\n                            <label for=\"gra-4\" class=\"checkbox\">\r\n                                <input type=\"checkbox\" id=\"gra-4\" ng-model=\"waterShow\">\r\n                                <i></i> {{getWord(\'Water\')}}</label>\r\n                        </div>\r\n                    </div>\r\n\r\n                    <div class=\"padding-10\">\r\n                        <div id=\"flotcontainer\" class=\"chart-large has-legend-unique padding-10\" flot-basic flot-data=\"revenewData\"\r\n                             flot-options=\"revenewDisplayOptions\"></div>\r\n                    </div>\r\n                </div>\r\n                <!-- end s3 tab pane -->\r\n            </div>\r\n\r\n            <!-- end content -->\r\n        </div>\r\n\r\n    </div>\r\n    <!-- end widget div -->\r\n</div>\r\n");
...
$templateCache.put("app/auth/directives/login-info.tpl.html","<div class=\"login-info ng-cloak\">\n    <span> <!-- User image size is adjusted inside CSS, it should stay as it -->\n        <a ng-if=\"isAuthenticated\" data-ui-sref=\"app.account.settings\">\n            <img ng-src=\"{{user.picture}}\" alt=\"me\" class=\"online\">\n                <span>{{user.lastName}}\n                </span>\n            <!--<i class=\"fa fa-angle-down\"></i>-->\n        </a>\n     </span>\n</div>\n");
$templateCache.put("app/calendar/directives/full-calendar.tpl.html","<div jarvis-widget data-widget-color=\"orange\" data-widget-deletebutton=\"false\" data-widget-editbutton=\"false\">\r\n    <header>\r\n        <span class=\"widget-icon\"> <i class=\"fa fa-calendar\"></i> </span>\r\n\r\n        <h2> {{$root.getWord(\'Work Calendar\')}} </h2>\r\n\r\n        <div class=\"widget-toolbar\">\r\n            <!-- add: non-hidden - to disable auto hide -->\r\n            <div class=\"btn-group dropdown\" dropdown >\r\n                <button class=\"btn dropdown-toggle btn-xs btn-default\" data-toggle=\"dropdown\">\r\n                    {{$root.getWord(\'Showing\')}} <i class=\"fa fa-caret-down\"></i>\r\n                </button>\r\n                <ul class=\"dropdown-menu js-status-update pull-right\">\r\n                    <li>\r\n                        <a ng-click=\"changeView(\'month\')\">{{$root.getWord(\'Month\')}}</a>\r\n                    </li>\r\n                    <li>\r\n                        <a ng-click=\"changeView(\'agendaWeek\')\">{{$root.getWord(\'Work orders\')}}</a>\r\n                    </li>\r\n                    <li>\r\n                        <a ng-click=\"changeView(\'agendaDay\')\">{{$root.getWord(\'Today\')}}</a>\r\n                    </li>\r\n                </ul>\r\n            </div>\r\n        </div>\r\n    </header>\r\n\r\n    <!-- widget div-->\r\n    <div>\r\n        <div class=\"widget-body no-padding\">\r\n            <!-- content goes here -->\r\n            <div class=\"widget-body-toolbar\">\r\n\r\n                <div id=\"calendar-buttons\">\r\n\r\n                    <div class=\"btn-group\">\r\n                        <a ng-click=\"prev()\" class=\"btn btn-default btn-xs\"><i\r\n                                class=\"fa fa-chevron-left\"></i></a>\r\n                        <a ng-click=\"next()\" class=\"btn btn-default btn-xs\"><i\r\n                                class=\"fa fa-chevron-right\"></i></a>\r\n                    </div>\r\n                </div>\r\n            </div>\r\n            <div id=\"calendar\"></div>\r\n\r\n            <!-- end content -->\r\n        </div>\r\n\r\n    </div>\r\n    <!-- end widget div -->\r\n</div>\r\n");
...
$templateCache.put("app/dashboard/assets/directives/assets-tree-grid.tpl.html","<div>\n\n    <div class=\"navbar navbar-default no-padding\">\n\n        <!-- Brand and toggle get grouped for better mobile display -->\n        <div class=\"navbar-header\">\n            <button type=\"button\" class=\"navbar-toggle\" data-toggle=\"collapse\"\n                    data-target=\"#bs-example-navbar-collapse-1\">\n                <span class=\"sr-only\">Toggle navigation</span>\n                <span class=\"icon-bar\"></span>\n                <span class=\"icon-bar\"></span>\n                <span class=\"icon-bar\"></span>\n            </button>\n        </div>\n\n        <!-- Collect the nav links, forms, and other content for toggling -->\n        <div class=\"collapse navbar-collapse\" id=\"bs-example-navbar-collapse-1\">\n            <form class=\"navbar-form navbar-left\" role=\"search\">\n                <div class=\"form-group\">\n                    <input type=\"text\" class=\"form-control\"\n                           placeholder=\"{{$root.getWord(\'Search\')}}\">\n                </div>\n                <button type=\"submit\" class=\"btn btn-default\">\n                    {{$root.getWord(\'Search\')}}\n                </button>\n            </form>\n            <ul class=\"nav navbar-nav navbar-right\">\n                <li class=\"btn-group dropdown\" data-dropdown>\n                    <a href=\"javascript:void(0);\" class=\"dropdown-toggle\"\n                       data-toggle=\"dropdown\">\n                        {{$root.getWord(\'Import data\')}}\n                        <span class=\"caret\"></span>\n                    </a>\n                    <ul class=\"dropdown-menu\">\n                        <li>\n                            <a  ng-click=\"openAssetImportModal()\">{{$root.getWord(\'Add\')}}</a>\n                        </li>\n                        <li class=\"divider\"></li>\n                        <li>\n                            <a href=\"javascript:void(0);\" ng-click=\"assets_tree.expand_all()\">\n                                {{$root.getWord(\'Expand All\')}}\n                            </a>\n                        </li>\n                        <li>\n                            <a href=\"javascript:void(0);\" ng-click=\"assets_tree.collapse_all()\">\n                                {{$root.getWord(\'Collapse All\')}}\n                            </a>\n                        </li>\n                    </ul>\n                </li>\n            </ul>\n        </div><!-- /.navbar-collapse -->\n    </div>\n    <div class=\"col-sm-12\">\n        <tree-grid\n                icon-leaf=\"fa fa-gear\"\n                tree-control=\"assets_tree\"\n                expand-level=\"2\"\n                tree-data=\"tree_data\"\n                on-click=\"openAssetEditModal(branch)\"\n                col-defs=\"col_defs\"\n                template-url=\"app/dashboard/assets/tree-grid.tpl.html\"\n                expand-on=\"expanding_property\"></tree-grid>\n    </div>\n</div>\n");
...
$templateCache.put("app/dashboard/workOrders/directives/nested-data-form.tpl.html","<div class=\"well well-light\">\n    <div id=\"{{handler}}\" class=\"{{reusableFormClass}}\">\n        <div>\n            <div>\n                <div>\n                    <h4 class=\"form-title\">{{header}}</h4>\n                </div>\n                <div class=\"form-body\">\n                </div>\n                <div class=\"form-footer\">\n                    <span ng-hide=\"angular.equals({}, footer)\" ng-bind-html=\"footer\"></span>\n                    <button type=\"button\" class=\"btn btn-default\" ng-click=\"closeForm()\">\n                        {{$root.getWord(\'Cancel\')}}\n                    </button>\n                </div>\n            </div>\n        </div>\n    </div>\n</div>");
$templateCache.put("app/dashboard/workOrders/directives/work-order-asset-widget.tpl.html","<div id=\"work-orders\" data-jarvis-widget data-widget-editbutton=\"false\" data-widget-deletebutton=\"false\"\n     data-widget-color=\"teal\">\n    <header>\n        <span class=\"widget-icon\"> <i class=\"fa fa-briefcase\"></i> </span>\n\n        <h2>{{$root.getWord(\'Work orders\')}}</h2>\n        <ul class=\"nav nav-tabs pull-right in\" id=\"workTab\">\n            <li class=\"active\">\n                <a data-toggle=\"tab\" href=\"#s5\"><i class=\"fa fa-briefcase\"></i> {{$root.getWord(\'Work orders\')}}</a>\n            </li>\n\n            <li>\n                <a data-toggle=\"tab\" href=\"#s6\"><i class=\"fa fa-cogs\"></i> <span class=\"hidden-mobile hidden-tablet\">{{$root.getWord(\'Assets\')}}</span></a>\n            </li>\n        </ul>\n    </header>\n\n    <!-- widget div-->\n    <div role=\"content\">\n        <!-- widget content -->\n        <div class=\"widget-body no-padding\">\n            <div id=\"myTabContent\" class=\"tab-content\">\n                <div class=\"tab-pane fade active in padding-10 no-padding-bottom\" id=\"s5\">\n\n                    <work-orders-assets-tree-grid></work-orders-assets-tree-grid>\n                </div>\n                <div class=\"tab-pane fade in padding-10 no-padding-bottom\" id=\"s6\">\n\n                    <!-- widget div-->\n                    <div>\n                        <!-- widget content -->\n                        <div class=\"widget-body\">\n                            <assets-tree-grid></assets-tree-grid>\n                        </div>\n                        <!-- end widget content -->\n                    </div>\n                    <!-- end widget div -->\n                </div>\n            </div>\n            <!-- end widget content -->\n        </div>\n\n        <!-- end widget div -->\n    </div>\n</div>");
$templateCache.put("app/dashboard/workOrders/directives/work-order-assets-tree-grid.tpl.html","<div>\n\n    <div class=\"navbar navbar-default no-padding\">\n\n        <!-- Brand and toggle get grouped for better mobile display -->\n        <div class=\"navbar-header\">\n            <button type=\"button\" class=\"navbar-toggle\" data-toggle=\"collapse\"\n                    data-target=\"#bs-example-navbar-collapse-1\">\n                <span class=\"sr-only\">Toggle navigation</span>\n                <span class=\"icon-bar\"></span>\n                <span class=\"icon-bar\"></span>\n                <span class=\"icon-bar\"></span>\n            </button>\n        </div>\n\n        <!-- Collect the nav links, forms, and other content for toggling -->\n        <div class=\"collapse navbar-collapse\" id=\"bs-example-navbar-collapse-1\">\n            <form class=\"navbar-form navbar-left\" role=\"search\">\n                <div class=\"form-group\">\n                    <input type=\"text\" class=\"form-control\"\n                           placeholder=\"{{$root.getWord(\'Search\')}}\">\n                </div>\n                <button type=\"submit\" class=\"btn btn-default\">\n                    {{$root.getWord(\'Search\')}}\n                </button>\n            </form>\n            <ul class=\"nav navbar-nav navbar-right\">\n                <li class=\"btn-group dropdown\" data-dropdown>\n                    <a href=\"javascript:void(0);\" class=\"dropdown-toggle\"\n                       data-toggle=\"dropdown\">\n                        {{$root.getWord(\'Import data\')}}\n                        <span class=\"caret\"></span>\n                    </a>\n                    <ul class=\"dropdown-menu\">\n                        <li>\n                            <a href=\"#{{assetModal}}\" ng-click=\"openAssetImportModal()\" data-target=\"#assetModal\"\n                               data-toggle=\"modal\">{{$root.getWord(\'Add\')}}</a>\n                        </li>\n                        <li class=\"divider\"></li>\n                        <li>\n                            <a href=\"javascript:void(0);\" ng-click=\"assets_tree.expand_all()\">\n                                {{$root.getWord(\'Expand All\')}}\n                            </a>\n                        </li>\n                        <li>\n                            <a href=\"javascript:void(0);\" ng-click=\"assets_tree.collapse_all()\">\n                                {{$root.getWord(\'Collapse All\')}}\n                            </a>\n                        </li>\n                    </ul>\n                </li>\n            </ul>\n        </div><!-- /.navbar-collapse -->\n    </div>\n    <div class=\"col-sm-12\">\n        <tree-grid\n                icon-leaf=\"fa fa-gear\"\n                tree-control=\"work_order_assets_tree\"\n                expand-level=\"3\"\n                tree-data=\"tree_data\"\n                col-defs=\"col_defs\"\n                template-url=\"app/dashboard/assets/tree-grid.tpl.html\"\n                expand-on=\"expanding_property\"></tree-grid>\n    </div>\n\n\n    <!-- Modal -->\n    <reusable-modal modal-data-id=\"workOrderAssetModal\" modal-body=\"workOrderAssetImportBody\" modal-footer=\"workOrderAssetImportFooter\"\n                    modal-header=\"workOrderAssetImportHeader\" data-ng-click-right-button=\"workOrderAssetImportModalClose()\"></reusable-modal>\n\n</div>");
$templateCache.put("app/dashboard/workOrders/directives/work-order-form.tpl.html","<div class=\"widget-body\">\n    <form class=\"form-horizontal\">\n        <fieldset>\n            <div class=\"row\">\n                <div class=\"col-md-12\">\n                    <label>{{$root.getWord(\'Assets\')}}</label>\n                    <select data-smart-select2 class=\"select2 col-xs-12 col-sm-12 col-md-12\"\n                            ng-model=\"workOrder.assetId\">\n                        <optgroup label=\"{{$root.getWord(\'Assets\')}}\">\n                            <option ng-repeat=\"asset in assets\" value=\"{{asset.id}}\">{{asset.name}}</option>\n                        </optgroup>\n                    </select>\n                </div>\n            </div>\n        </fieldset>\n        <fieldset>\n            <legend>\n            </legend>\n            <div class=\"row\">\n                <div class=\"col-md-6 \">\n                    <label class=\"control-label\">{{$root.getWord(\'Code\')}}</label>\n                    <div class=\"col-md-12\">\n                        <input type=\"text\" class=\"form-control\" ng-model=\"workOrder.code\" ng-disabled=\"disableForm\">\n                    </div>\n                </div>\n\n\n                <div class=\"col-md-6\">\n                    <label class=\"control-label\">{{$root.getWord(\'Number\')}}</label>\n                    <div class=\"col-md-12\">\n                        <input type=\"text\" class=\"form-control\" ng-model=\"workOrder.number\" ng-disabled=\"disableForm\">\n                    </div>\n                </div>\n            </div>\n        </fieldset>\n        <fieldset>\n            <legend>\n            </legend>\n            <div class=\"row\">\n                <div class=\"col-md-12\">\n                    <label class=\"col-md-2 control-label\">{{$root.getWord(\'Work order state\')}}</label>\n                    <div class=\"col-md-10 padding-bottom-10\">\n                        <div class=\"radio\">\n                            <label>\n                                <input type=\"radio\" class=\"radiobox style-0\" name=\"state\" value=\"N\" ng-model=\"workOrderState\">\n                                <span>{{$root.getWord(\'Normal\')}}</span>\n                            </label>\n                            <label>\n                                <input type=\"radio\" class=\"radiobox style-0\" name=\"state\" value=\"E\" ng-model=\"workOrderState\">\n                                <span>{{$root.getWord(\'Emergency\')}}</span>\n                            </label>\n                        </div>\n                    </div>\n                </div>\n            </div>\n            <div ng-hide=\"workOrderState == \'E\'\" class=\"well well-light\">\n                <div class=\"row\">\n                    <div class=\"col-xs-12 col-sm-4 col-md-4\">\n                        <div class=\"panel panel-primary height-150\">\n                            <div class=\"panel-heading bg-color-blueDark txt-color-white\">\n                                <h3 class=\"panel-title\">\n                                    {{$root.getWord(\'Weekday\')}}</h3>\n                            </div>\n                            <div class=\"panel-body no-padding\">\n                                <div class=\"row\">\n                                    <div class=\"col-md-12\">\n                                        <div class=\"radio\">\n                                            <label>\n                                                <input type=\"radio\" class=\"radiobox style-0\" ng-model=\"workOrderWeek\" value=\"EW\"\n                                                       name=\"weekday\">\n                                                <span>{{$root.getWord(\'Every Weekday\')}}</span>\n                                            </label>\n                                        </div>\n                                        <div class=\"radio\">\n                                            <label>\n                                                <input type=\"radio\" class=\"radiobox style-0\" name=\"weekday\" ng-model=\"workOrderWeek\" value=\"MF\">\n                                                <span>{{$root.getWord(\'Monday-Friday\')}}</span>\n                                            </label>\n                                        </div>\n                                        <div class=\"radio\">\n                                            <label>\n                                                <input type=\"radio\" class=\"radiobox style-0\" name=\"weekday\" ng-model=\"workOrderWeek\" value=\"WD\">\n                                                <span>{{$root.getWord(\'Weekend Days\')}}</span>\n                                            </label>\n                                        </div>\n                                        <div class=\"radio\">\n                                            <label>\n                                                <input type=\"radio\" class=\"radiobox style-0\" name=\"weekday\" ng-model=\"workOrderWeek\" value=\"W\">\n                                                <span>{{$root.getWord(\'Week Day\')}}</span>\n                                            </label>\n                                        </div>\n                                    </div>\n                                </div>\n\n                                <div class=\"row padding-10\">\n                                    <div class=\"col-md-12\">\n                                        <select multiple=\"multiple\" id=\"multiselect1\" class=\"form-control custom-scroll\" ng-disabled=\"workOrderWeek != \'W\'\"\n                                                title=\"Select days\">\n                                            <option value=\"0\">Sat</option>\n                                            <option value=\"0\">Sun</option>\n                                            <option value=\"0\">Mon</option>\n                                            <option value=\"0\">Tue</option>\n                                            <option value=\"0\">Wed</option>\n                                            <option value=\"0\">Thu</option>\n                                            <option value=\"0\">Fri</option>\n                                        </select>\n                                    </div>\n                                </div>\n                            </div>\n                        </div>\n                    </div>\n                    <div class=\"col-xs-12 col-sm-4 col-md-4\">\n                        <div class=\"panel panel-primary height-150\">\n                            <div class=\"panel-heading bg-color-blueDark txt-color-white\">\n                                <h3 class=\"panel-title\">\n                                    {{$root.getWord(\'Months\')}}</h3>\n                            </div>\n                            <div class=\"panel-body no-padding\">\n                                <div class=\"row\">\n                                    <div class=\"col-md-12\">\n                                        <div class=\"radio\">\n                                            <label>\n                                                <input type=\"radio\" checked=\"checked\" class=\"radiobox style-0\" ng-model=\"workOrderMonth\" value=\"EVM\"\n                                                       name=\"month\">\n                                                <span>{{$root.getWord(\'Every Month\')}}</span>\n                                            </label>\n                                        </div>\n                                        <div class=\"radio\">\n                                            <label>\n                                                <input type=\"radio\" class=\"radiobox style-0\" name=\"month\" ng-model=\"workOrderMonth\" value=\"EM\">\n                                                <span>{{$root.getWord(\'Even Months\')}}</span>\n                                            </label>\n                                        </div>\n                                        <div class=\"radio\">\n                                            <label>\n                                                <input type=\"radio\" class=\"radiobox style-0\" name=\"month\" ng-model=\"workOrderMonth\" value=\"OM\">\n                                                <span>{{$root.getWord(\'Odd Months\')}}</span>\n                                            </label>\n                                        </div>\n                                        <div class=\"radio\">\n                                            <label>\n                                                <input type=\"radio\" class=\"radiobox style-0\" name=\"month\" ng-model=\"workOrderMonth\" value=\"E4M\">\n                                                <span>{{$root.getWord(\'Every 4 Months\')}}</span>\n                                            </label>\n                                        </div>\n                                        <div class=\"radio\">\n                                            <label>\n                                                <input type=\"radio\" class=\"radiobox style-0\" name=\"month\" ng-model=\"workOrderMonth\" value=\"EHY\">\n                                                <span>{{$root.getWord(\'Every Half Year\')}}</span>\n                                            </label>\n                                        </div>\n                                        <div class=\"radio\">\n                                            <label>\n                                                <input type=\"radio\" class=\"radiobox style-0\" name=\"month\" ng-model=\"workOrderMonth\" value=\"M\">\n                                                <span>{{$root.getWord(\'Month(s)\')}}</span>\n                                            </label>\n                                        </div>\n                                    </div>\n                                </div>\n\n                                <div class=\"row padding-10 bottom-element\">\n                                    <div class=\"col-md-12\">\n                                        <select multiple=\"multiple\" id=\"multiselect2\" class=\"form-control custom-scroll\" ng-disabled=\"workOrderMonth != \'M\'\"\n                                                title=\"Select days\">\n                                            <option value=\"1\">Jan</option>\n                                            <option value=\"2\">Feb</option>\n                                            <option value=\"3\">Mar</option>\n                                            <option value=\"4\">Apr</option>\n                                            <option value=\"5\">May</option>\n                                            <option value=\"6\">Jun</option>\n                                            <option value=\"7\">Jul</option>\n                                            <option value=\"8\">Aug</option>\n                                            <option value=\"9\">Sep</option>\n                                            <option value=\"10\">Oct</option>\n                                            <option value=\"11\">Nov</option>\n                                            <option value=\"12\">Dec</option>\n                                        </select>\n                                    </div>\n                                </div>\n                            </div>\n                        </div>\n                    </div>\n                    <div class=\"col-xs-12 col-sm-4 col-md-4\">\n                        <div class=\"panel panel-primary\">\n                            <div class=\"panel-heading bg-color-blueDark txt-color-white\">\n                                <h3 class=\"panel-title\">\n                                    {{$root.getWord(\'Days\')}}</h3>\n                            </div>\n                            <div class=\"panel-body no-padding\">\n                                <div class=\"row\">\n                                    <div class=\"col-md-12\">\n                                        <div class=\"radio\">\n                                            <label>\n                                                <input type=\"radio\" checked=\"checked\" class=\"radiobox style-0\" ng-model=\"workOrderDay\" value=\"EVD\"\n                                                       name=\"days\">\n                                                <span>{{$root.getWord(\'Every Day\')}}</span>\n                                            </label>\n                                        </div>\n                                        <div class=\"radio\">\n                                            <label>\n                                                <input type=\"radio\" class=\"radiobox style-0\" name=\"days\" ng-model=\"workOrderDay\" value=\"ED\">\n                                                <span>{{$root.getWord(\'Even Days\')}}</span>\n                                            </label>\n                                        </div>\n                                        <div class=\"radio\">\n                                            <label>\n                                                <input type=\"radio\" class=\"radiobox style-0\" name=\"days\" ng-model=\"workOrderDay\" value=\"OD\">\n                                                <span>{{$root.getWord(\'Odd Days\')}}</span>\n                                            </label>\n                                        </div>\n                                        <div class=\"radio\">\n                                            <label>\n                                                <input type=\"radio\" class=\"radiobox style-0\" name=\"days\" ng-model=\"workOrderDay\" value=\"E5D\">\n                                                <span>{{$root.getWord(\'Every 5 Days\')}}</span>\n                                            </label>\n                                        </div>\n                                        <div class=\"radio\">\n                                            <label>\n                                                <input type=\"radio\" class=\"radiobox style-0\" name=\"days\" ng-model=\"workOrderDay\" value=\"E10D\">\n                                                <span>{{$root.getWord(\'Every 10 Days\')}}</span>\n                                            </label>\n                                        </div>\n                                        <div class=\"radio\">\n                                            <label>\n                                                <input type=\"radio\" class=\"radiobox style-0\" name=\"style-0\" ng-model=\"workOrderDay\" value=\"EHM\">\n                                                <span>{{$root.getWord(\'Every Half Month\')}}</span>\n                                            </label>\n                                        </div>\n                                        <div class=\"radio\">\n                                            <label>\n                                                <input type=\"radio\" class=\"radiobox style-0\" name=\"style-0\" ng-model=\"workOrderDay\" value=\"D\">\n                                                <span>{{$root.getWord(\'Day(s)\')}}</span>\n                                            </label>\n                                        </div>\n                                    </div>\n                                </div>\n\n                                <div class=\"row padding-10\">\n                                    <div class=\"col-md-12\">\n                                        <select multiple=\"multiple\" id=\"multiselect3\" class=\"form-control custom-scroll\" ng-disabled=\"workOrderDay != \'D\'\"\n                                                title=\"Select days\">\n                                            <option value=\"1\">1</option>\n                                            <option value=\"2\">2</option>\n                                            <option value=\"3\">3</option>\n                                            <option value=\"4\">4</option>\n                                            <option value=\"5\">5</option>\n                                            <option value=\"6\">6</option>\n                                            <option value=\"7\">7</option>\n                                            <option value=\"8\">8</option>\n                                            <option value=\"9\">9</option>\n                                            <option value=\"10\">10</option>\n                                            <option value=\"11\">11</option>\n                                            <option value=\"12\">12</option>\n                                            <option value=\"13\">13</option>\n                                            <option value=\"14\">14</option>\n                                            <option value=\"15\">15</option>\n                                            <option value=\"16\">16</option>\n                                            <option value=\"17\">17</option>\n                                            <option value=\"18\">18</option>\n                                            <option value=\"19\">19</option>\n                                            <option value=\"20\">20</option>\n                                            <option value=\"21\">21</option>\n                                            <option value=\"22\">22</option>\n                                            <option value=\"23\">23</option>\n                                            <option value=\"24\">24</option>\n                                            <option value=\"25\">25</option>\n                                            <option value=\"26\">26</option>\n                                            <option value=\"27\">27</option>\n                                            <option value=\"28\">28</option>\n                                            <option value=\"29\">29</option>\n                                            <option value=\"30\">30</option>\n                                            <option value=\"31\">31</option>\n                                        </select>\n                                    </div>\n                                </div>\n                            </div>\n                        </div>\n                    </div>\n                </div>\n            </div>\n            <div class=\"row\">\n                <div class=\"col-md-12\">\n                    <label class=\"control-label\">{{$root.getWord(\'Work order description\')}}</label>\n                    <div class=\"col-md-12\">\n                        <textarea type=\"text\" class=\"form-control\" ng-model=\"workOrder.desc\" ng-disabled=\"disableForm\"></textarea>\n                    </div>\n                </div>\n            </div>\n        </fieldset>\n    </form>\n\n</div>");
$templateCache.put("app/dashboard/workOrders/directives/work-order.tpl.html","<div>\n    <div class=\"navbar navbar-default no-padding\">\n\n        <!-- Brand and toggle get grouped for better mobile display -->\n        <div class=\"navbar-header\">\n            <button type=\"button\" class=\"navbar-toggle\" data-toggle=\"collapse\"\n                    data-target=\"#bs-example-navbar-collapse-1\">\n                <span class=\"sr-only\">Toggle navigation</span>\n                <span class=\"icon-bar\"></span>\n                <span class=\"icon-bar\"></span>\n                <span class=\"icon-bar\"></span>\n            </button>\n        </div>\n\n        <!-- Collect the nav links, forms, and other content for toggling -->\n        <div class=\"collapse navbar-collapse\" id=\"bs-example-navbar-collapse-1\">\n            <ul class=\"nav navbar-nav navbar-right\">\n                <li class=\"btn-group dropdown\" data-dropdown>\n                    <a href=\"javascript:void(0);\" class=\"dropdown-toggle\"\n                       data-toggle=\"dropdown\">\n                        {{$root.getWord(\'Import data\')}}\n                        <span class=\"caret\"></span>\n                    </a>\n                    <ul class=\"dropdown-menu\">\n                        <li>\n                            <a href=\"#{{workOrderModal}}\" ng-click=\"openWorkOrderAddModal()\"\n                               data-target=\"#workOrderModal\"\n                               data-toggle=\"modal\">{{$root.getWord(\'Add\')}}</a>\n                        </li>\n                    </ul>\n                </li>\n            </ul>\n        </div><!-- /.navbar-collapse -->\n    </div>\n\n\n    <table datatable-basic data-table-options=\"workOrdersTableOptions\"\n           class=\"display projects-table table table-striped table-bordered table-hover\"\n           cellspacing=\"0\" width=\"100%\">\n        <thead>\n        <tr>\n            <th></th>\n            <th data-hide=\"phone,tablet\">{{$root.getWord(\'ID\')}}</th>\n            <th>{{$root.getWord(\'Asset name\')}}</th>\n            <th>{{$root.getWord(\'Type\')}}</th>\n            <th data-hide=\"phone\">{{$root.getWord(\'Status\')}}</th>\n            <th data-hide=\"phone\"><i class=\"fa fa-fw fa-user text-muted\"></i>{{$root.getWord(\'Est\')}}\n            </th>\n            <th data-hide=\"phone\">{{$root.getWord(\'Priority\')}}</th>\n            <th data-hide=\"phone,tablet\"><i\n                    class=\"fa fa-fw fa-calendar text-muted hidden-mobile\"></i>\n                {{$root.getWord(\'Estimated hours\')}}\n            </th>\n            <th>{{$root.getWord(\'Tracker\')}}</th>\n            <th data-hide=\"phone,tablet\"><i\n                    class=\"fa fa-fw fa-user text-muted hidden-md hidden-sm hidden-xs\"></i>\n                {{$root.getWord(\'Users\')}}\n            </th>\n            <th>{{$root.getWord(\'Action\')}}</th>\n        </tr>\n        </thead>\n        <caption class=\"smart-datatable-child-format\" data-child-control=\"td.details-control\">\n            <table cellpadding=\"5\" cellspacing=\"0\" border=\"0\"\n                   class=\"table table-hover table-condensed\">\n                <tr>\n                    <td style=\"width:100px\">تجهیز:</td>\n                    <td ng-bind-html=\"d.assets\"></td>\n                </tr>\n                <tr>\n                    <td>توضیحات:</td>\n                    <td ng-bind-html=\"d.description\">}</td>\n                </tr>\n                <tr>\n                    <td>ملاحضات:</td>\n                    <td ng-bind-html=\"d.comments\"></td>\n                </tr>\n                <tr>\n                    <td>تاریخ پایان:</td>\n                    <td ng-bind-html=\"d.date-completed\"></td>\n                </tr>\n            </table>\n        </caption>\n    </table>\n\n    <!-- Modal -->\n    <reusable-modal ng-if=\"nested != \'nested\'\" modal-data-id=\"workOrderModal\" modal-body=\"workOrderImportBody\"\n                    modal-class=\"workOrderModalClass\"\n                    modal-footer=\"workOrderImportFooter\"\n                    modal-header=\"workOrderImportHeader\"\n                    data-ng-click-right-button=\"workOrderImportModalClose()\"></reusable-modal>\n    <nested-data-form ng-if=\"nested == \'nested\'\" form-data-id=\"workOrderModal\"\n                      form-body=\"workOrderImportBody\"\n                      form-footer=\"workOrderImportFooter\"\n                      form-header=\"workOrderImportHeader\"\n    ></nested-data-form>\n</div>");
...
(function () {
    ...
    function stateConfig($stateProvider) {
        $stateProvider.state('app.admin.user-management', {
            url: '/user-management',
            data: {
                authorities: ['ROLE_ADMIN'],
        ...
        }).state('app.admin.user-management-detail', {
            url: '/user/:login',
            data: {
                authorities: ['ROLE_ADMIN'],
            ...
            .state('app.admin.user-management.new', {
                url: '/new',
                data: {
                    authorities: ['ROLE_ADMIN']
                },
            ...
            .state('app.admin.user-management.edit', {
            url: '/{login}/edit',
            data: {
                authorities: ['ROLE_ADMIN']
            },
            ...
            .state('app.admin.user-management.delete', {
                url: '/{login}/delete',
                data: {
                    authorities: ['ROLE_ADMIN']
                },
...
angular.module('app').factory('Project', function($http, APP_CONFIG){
    return {
        list: $http.get(APP_CONFIG.apiRootUrl + '/project-list.json')
    }
});
"use strict";
...
(function() {
    ...
    function WorkOrderController ($scope, $state, WorkOrder, ParseLinks, AlertService, paginationConstants, pagingParams) {
        var vm = this;
...
(function() {
    ...
    NavigationController.$inject = ['$state', 'Auth', 'Principal', 'ProfileService', 'LoginService'];

    function NavigationController ($state, Auth, Principal, ProfileService, LoginService) {
        var vm = this;
...
angular
    ...
    angular
        .module('app')
        .factory('Auth', function ($rootScope, $state, $sessionStorage, $q, Principal, AuthServerProvider, Account, LoginService, Register, Activate, Password, PasswordResetInit, PasswordResetFinish) {
        var service = {
...
angular
    .module('app')
    .factory('AuthServerProvider', function ($http, $localStorage, $rootScope) {
        var service = {
            getToken: getToken,
        ...
        function logout() {
            ...
            $http.post('api/logout').success(function (response) {
                ...
                $http.get('api/account').then(function(r) {}, function(response) {});
                return response;
            });
...
angular
    .module('app')
    .directive('pageRibbon', function (ProfileService, $rootScope, $translate) {
        var directive = {
            replace: true,
            restrict: 'AE',
...
angular.module('app.chat').factory('ChatApi', function ($q, $rootScope, Users, $http, APP_CONFIG) {
    var dfd = $q.defer();
    var _user;
    var ChatSrv = {
        initialized: dfd.promise,
    ...
    return {
        ...
        link: function (scope, element, attributes) {
            ...
            if(attributes.bindFilters){
                element.parent().find("div.toolbar").html('<div class="text-right"><img src="content/img/logo.png" alt="SmartAdmin" style="width: 111px; margin-top: 3px; margin-right: 10px;"></div>');
...
angular.module('SmartAdmin.Layout').directive('demoStates', function ($rootScope) {
    return {
        ...
        controller: function ($scope) {
            ...
            localStorage.setItem('sm-fixed-navigation', 'true');
            localStorage.setItem('sm-fixed-ribbon', 'true');
            localStorage.setItem('sm-fixed-page-footer', 'true');
            localStorage.setItem('sm-rtl', 'true');
