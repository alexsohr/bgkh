    ...
    return {
        ...
        link: function (scope, element, attributes) {
            ...
            if(attributes.bindFilters){
                element.parent().find("div.toolbar").html('<div class="text-right"><img src="content/images/logo.png" alt="SmartAdmin" style="width: 111px; margin-top: 3px; margin-right: 10px;"></div>');
