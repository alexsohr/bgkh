...
public interface WorkOrderHistoryRepository extends JpaRepository<WorkOrderHistory,Long> {
    ...
    @Query("select workOrderHistory from WorkOrderHistory workOrderHistory where workOrderHistory.workOrderSchedule.asset.id = :id order by workOrderHistory.workOrderSchedule.createDate desc, workOrderHistory.createDate desc")
